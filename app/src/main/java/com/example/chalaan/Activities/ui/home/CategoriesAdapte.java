...
public class CategoriesAdapte extends RecyclerView.Adapter<CategoriesAdapte.AdapterAllCategoriesViewHolder> {

    ArrayList<CategoriesHelperClass> mostViewedLocations;

    public CategoriesAdapte(ArrayList<CategoriesHelperClass> mostViewedLocations) {
